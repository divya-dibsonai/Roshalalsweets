...
const sweets = [
  { image: '/images/sweets/Bengali Sweets.png', tag: 'Bengali Sweets', name: 'Bengali Mix', desc: 'Assorted Bengali sweets in one mixed selection', price: 'TBD', bg: 'bg-pink-50', category: 'Bengali Sweets' },
  ...
  { image: '/images/sweets/Rasmalai.png', tag: 'Bengali Sweets', name: 'Rasmalai', desc: 'Chena discs soaked in sweetened, cardamom-flavoured milk', price: 'TBD', bg: 'bg-pink-50', category: 'Bengali Sweets' },
  { image: '/images/sweets/Chappan Bhog.png', tag: 'Desi Ghee Sweets', name: '1 Pc Chappan Bhog', desc: 'Single-serve platter of 56 traditional festive sweets', price: 'TBD', bg: 'bg-amber-50', category: 'Desi Ghee Sweets' },
  { image: '/images/sweets/Chappan Bhog Thal.png', tag: 'Desi Ghee Sweets', name: 'Chappan Bhog Thal', desc: 'Two-piece platter of assorted 56-bhog sweets', price: 'TBD', bg: 'bg-amber-50', category: 'Desi Ghee Sweets' },
  ...
  { emoji: '🍯', tag: 'Guilt Free', name: 'Feeki Balushahi', desc: 'Mildly sweetened balushahi for a lighter treat', price: 'TBD', bg: 'bg-amber-50', category: 'Desi Ghee Sweets' },
  { image: '/images/sweets/Gujiya.png', tag: 'Guilt Free', name: 'Feeki Gujiya', desc: 'Low-sugar gujiya with a milder sweet filling', price: 'TBD', bg: 'bg-amber-50', category: 'Desi Ghee Sweets' },
  { image: '/images/sweets/Gujiya copy.png', tag: 'Desi Ghee Sweets', name: 'Gujiya', desc: 'Holi special khoya-filled pastries, fried to perfection', price: 'TBD', bg: 'bg-pink-50', category: 'Desi Ghee Sweets' },
  ...
  { image: '/images/sweets/Sonpapdi.png', tag: 'Desi Ghee Sweets', name: 'Mewa Soanpapdi', desc: 'Flaky soan papdi loaded with dry fruits', price: 'TBD', bg: 'bg-amber-50', category: 'Desi Ghee Sweets' },
  { image: '/images/sweets/Mix Mithai.png', tag: 'Desi Ghee Sweets', name: 'Mix Mithai', desc: 'Assorted selection of our classic mithai', price: 'TBD', bg: 'bg-amber-50', category: 'Desi Ghee Sweets' },
  ...
  { image: '/images/sweets/Sugarless Sonpapdi.png', tag: 'Guilt Free', name: 'S L Soan Papdi', desc: 'Sugar-free take on the classic flaky soan papdi', price: 'TBD', bg: 'bg-amber-50', category: 'Desi Ghee Sweets' },
  ...
  { emoji: '🍯', tag: 'Guilt Free', name: 'Sugar Less Mix', desc: 'Assorted sugar-free sweets for a guilt-free treat', price: 'TBD', bg: 'bg-amber-50', category: 'Desi Ghee Sweets' },
  { image: '/images/sweets/Gur Kaju Roll Gazak.png', tag: 'Gazak', name: 'Gur Kaju Roll Gazak', desc: 'Jaggery and cashew rolled into a crunchy gazak', price: 'TBD', bg: 'bg-green-50', category: 'Seasonal Sweets' },
  ...
  { image: '/images/sweets/Moongfali Patti.png', tag: 'Gazak', name: 'Moongfali Patti', desc: 'Peanut brittle made with jaggery, a winter favourite', price: 'TBD', bg: 'bg-green-50', category: 'Seasonal Sweets' },
  { image: '/images/sweets/Kutema Gur Gazak.png', tag: 'Gazak', name: 'Sada Gazak [Kutema]', desc: 'Plain sesame and jaggery winter gazak', price: 'TBD', bg: 'bg-green-50', category: 'Seasonal Sweets' },
  { image: '/images/sweets/Shahi Gur Gazak.png', tag: 'Gazak', name: 'Shahi Gur Gazak', desc: 'Premium gazak loaded with dry fruits', price: 'TBD', bg: 'bg-green-50', category: 'Seasonal Sweets' },
  ...
  { image: '/images/sweets/Anjeer Balls.png', tag: 'Mewa Sweets', name: 'Anjeer Balls', desc: 'Rolled fig sweet stuffed with dry fruits', price: 'TBD', bg: 'bg-orange-50', category: 'Mewa Sweets' },
  ...
  { image: '/images/sweets/Gulab Fruit.png', tag: 'Mewa Sweets', name: 'Gulab Fruit Burfi', desc: 'Fruit-flavoured burfi with a hint of rose', price: 'TBD', bg: 'bg-orange-50', category: 'Mewa Sweets' },
  ...
  { image: '/images/sweets/Kaju Barfi.png', tag: 'Mewa Sweets', name: 'Kaju Burfi', desc: 'Premium cashew fudge, rich and smooth', price: 'TBD', bg: 'bg-orange-50', category: 'Mewa Sweets' },
  ...
  { image: '/images/sweets/Kesar Kaju Ghevar.png', tag: 'Monsoon Special', name: 'Kesar Kaju Ghevar', desc: 'Saffron and cashew topped ghevar, rich and festive', price: 'TBD', bg: 'bg-green-50', category: 'Seasonal Sweets' },
  { image: '/images/sweets/Kesar Ghewar.png', tag: 'Monsoon Special', name: 'Kesar Ghevar', desc: 'Saffron-flavoured ghevar, a Teej and Rakhi favourite', price: 'TBD', bg: 'bg-green-50', category: 'Seasonal Sweets' },
  { image: '/images/sweets/Khoya Ghevar.png', tag: 'Monsoon Special', name: 'Khoya Ghevar', desc: 'Ghevar topped generously with rich khoya', price: 'TBD', bg: 'bg-green-50', category: 'Seasonal Sweets' },
  { image: '/images/sweets/Lite Ghevar.png', tag: 'Guilt Free', name: 'Lite Ghevar', desc: 'Lighter, less sweet version of classic ghevar', price: 'TBD', bg: 'bg-green-50', category: 'Seasonal Sweets' },
  ...
  { image: '/images/sweets/Malai Ghevar.png', tag: 'Monsoon Special', name: 'Malai Ghevar', desc: 'Ghevar topped with thick, creamy malai', price: 'TBD', bg: 'bg-green-50', category: 'Seasonal Sweets' },
  ...
  { image: '/images/sweets/Grill Sandwich.png', tag: 'Snacks', name: 'Grilled Cheese/ Paneer/ Veg Sandwich', desc: 'Toasted sandwich packed with fresh vegetables', price: 'TBD', bg: 'bg-gray-50', category: 'Snacks' },
  { image: '/images/sweets/Jalebi.png', tag: 'Snacks', name: 'Jalebi', desc: 'Crispy, syrup-soaked spirals, a classic Indian favourite', price: 'TBD', bg: 'bg-gray-50', category: 'Snacks' },
  { image: '/images/sweets/Kachori.png', tag: 'Snacks', name: 'Kachori Thali', desc: 'Full thali served with hot, spiced kachori', price: 'TBD', bg: 'bg-gray-50', category: 'Snacks' },
  { image: '/images/sweets/Kesar Badam Milk.jpg', tag: 'Snacks', name: 'Kesar Badam Milk', desc: 'Saffron and almond flavoured warm milk', price: 'TBD', bg: 'bg-gray-50', category: 'Snacks' },
  ...
  { image: '/images/sweets/Lassi.png', tag: 'Snacks', name: 'Lassi', desc: 'Thick, chilled sweet yogurt drink', price: 'TBD', bg: 'bg-gray-50', category: 'Snacks' },
  ...
  { image: '/images/sweets/Veg Cheese Burger.png', tag: 'Snacks', name: 'Veg Cheese Burger', desc: 'Vegetable patty burger topped with melted cheese', price: 'TBD', bg: 'bg-gray-50', category: 'Snacks' },
  ...
  { image: '/images/sweets/Gajar Halwa.jpg', tag: 'Winter Special', name: 'Gazar Halwa (Hot)', desc: 'Warm carrot halwa slow-cooked in milk and ghee', price: 'TBD', bg: 'bg-green-50', category: 'Seasonal Sweets' },
  ...
  { image: '/images/sweets/GajarPpak.png', tag: 'Winter Special', name: 'Gazar Paag', desc: 'Carrot-based paag sweet, rich and warming', price: 'TBD', bg: 'bg-green-50', category: 'Seasonal Sweets' },
  ...
  { image: '/images/sweets/Sada Gazar Halwa.png', tag: 'Winter Special', name: 'Sada Gazar Halwa', desc: 'Simple, classic carrot halwa cooked in milk', price: 'TBD', bg: 'bg-green-50', category: 'Seasonal Sweets' },
  ...
  { image: '/images/sweets/Til Laddoo.png', tag: 'Winter Special', name: 'Til Laddoo', desc: 'Sesame seed laddoo, a warming winter treat', price: 'TBD', bg: 'bg-green-50', category: 'Seasonal Sweets' },
];
