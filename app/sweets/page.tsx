...
const sweets = [
  ...
  { image: '/images/sweets/Lite Ghevar.png', tag: 'Monsoon Special', name: 'Lite Ghevar', desc: 'Lighter, less sweet version of classic ghevar', price: 'TBD', bg: 'bg-green-50', category: 'Seasonal Sweets' },
