export const namkeen = {
  'Healthy Bites': [
    ...
    { image: '/images/namkeen/Hing Peanut Namkeen.JPG', tag: 'Spicy', name: 'Hing Peanut Namkeen', desc: 'Crunchy peanuts seasoned with asafoetida', price: '₹—', bg: 'bg-amber-50' },
    ...
    { image: '/images/namkeen/Moong Bhujiya.JPG', tag: 'Healthy', name: 'Moong Bujiya', desc: 'Crispy fried moong dal bhujiya', price: '₹180/kg', bg: 'bg-yellow-50' },
    ...
    { image: '/images/namkeen/Roasted Makhana- Mint Pudina.JPG', tag: 'Healthy', name: 'Roasted Makhana Jar - Mint/Pudina', desc: 'Roasted fox nuts seasoned with mint', price: '₹300/kg', bg: 'bg-emerald-50' },
    { image: '/images/namkeen/Roasted Makhana- Chilli Tomato.JPG', tag: 'Healthy', name: 'Roasted Makhana Jar - Chilli Tomato', desc: 'Roasted fox nuts seasoned with chilli-tomato', price: '₹300/kg', bg: 'bg-red-50' },
    { image: '/images/namkeen/Roasted Makhana- salt & Pepper (Falhari).JPG', tag: 'Healthy', name: 'Roasted Makhana Jar - Salt & Pepper (Falhari)', desc: 'Roasted fox nuts with salt & pepper, fasting-friendly', price: '₹300/kg', bg: 'bg-amber-50' },
    ...
    { image: '/images/namkeen/Beetroot Chips- Chilli Chat.JPG', tag: 'Healthy', name: 'Beetroot Chips - Chilli Chat', desc: 'Crispy beetroot chips tossed in chaat masala', price: '₹180/kg', bg: 'bg-yellow-50' },
    ...
    { image: '/images/namkeen/salted Peanuts.png', tag: 'Classic', name: 'Salted Peanuts', desc: 'Simple roasted peanuts, lightly salted', price: '₹—', bg: 'bg-amber-50' },
